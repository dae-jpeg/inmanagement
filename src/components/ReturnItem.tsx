...
const ReturnItem = () => {
  ...
  useEffect(() => {
    ...
    // else {
    //   // Automatically open QR scanner when component mounts
    ...
    <div className="min-h-screen bg-background p-6">
      <header className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold">Return Item</h1>
        </div>
        <Button
      ...
      <main>
        ...
        {transactionComplete && selectedItemId ? (
          <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
            <div className="flex flex-col items-center justify-center py-6 space-y-4">
              ...
              <div className="text-center">
                <h3 className="font-medium text-lg">Return Successful!</h3>
                <p className="text-sm text-muted-foreground">
                  You have successfully returned the item.
                </p>
              </div>
          ...
          <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md text-center">
            <h2 className="text-xl font-semibold mb-4">Return an Item</h2>
            <p className="mb-6 text-muted-foreground">
              To return an item to inventory, please scan its QR code using the
              button above.
            </p>
